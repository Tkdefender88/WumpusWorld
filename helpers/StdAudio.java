...
public final class StdAudio {
    ...
    private static HashMap<String, AudioClip> clipCache = new HashMap<String, AudioClip>(); // map filename to audio clip
    private static boolean clipCaching = true;                                              // turns audio caching on/off
    
    // Turn clip caching on or off, by default caching is on.
    // This helps prevents glitches if sounds are played frequently.
